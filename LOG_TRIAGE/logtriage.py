...
from PyQt5.QtGui import QPalette, QIcon, QColor, QPixmap
...
if __name__ == "__main__":
    ...
    app.setStyle("Fusion")  # <-- Set Fusion style globally

    # Optionally, set the default palette (light or dark)
    set_light_palette(app)  # Start with light mode
    # set_dark_palette(app) # Or start with dark mode
